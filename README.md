...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-m1hrstw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-m1hrstw.containers.anotherwebservice.com/
...
```
git clone git@github.com:puneethrj/container-m1hrstw.git
cd container-m1hrstw
```
...
```
docker attach container-m1hrstw
```
